...
const NavBar = () => (
  <header className="w-fit fixed inset-x-0 top-0 z-50 py-4">
    <div className="max-w-7xl mx-auto px-6">
      <nav className="flex items-center justify-end p-3 rounded-2xl bg-white/6 backdrop-blur-sm">
        

        <div className="hidden md:flex items-center gap-4">
          <a href="#get-started" className="text-white/90 hover:underline">Get started</a>
          <a href="#docs" className="text-white/80 hover:underline">Docs</a>
          <a href="https://github.com/SamMegh/Vaani" target="_blank" rel="noreferrer" className="text-white/80">GitHub</a>
          <a href="#contact" className="px-4 py-2 rounded-2xl bg-white text-black font-semibold">Contact</a>
        </div>

        <div className="md:hidden">
          {/* mobile simple menu link */}
          <a href="#get-started" className="text-white/90 px-3 py-2 bg-white/6 rounded">Start</a>
        </div>
      </nav>
    </div>
  </header>
...
function LandingScreen() {
  return (
    ...
    <main>
      ...
      {/* spacer to prevent content under fixed navbar */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 bg-white/5 rounded-lg">
              <p className="text-white/80">
                “Vaani helped our team automate support replies and cut response
                time in half.”
              </p>
            ...
            <div className="p-4 bg-white/5 rounded-lg">
              ...
              <div className="mt-3 text-sm text-white/70">— Priya, Product</div>
            </div>
            <div className="p-4 bg-white/5 rounded-lg">
              <p className="text-white/80">
                “Easy to share chats with teammates and iterate together — saves
                time.”
              </p>
...
fetch('/chat/sendmessage', {
  ...
  body: JSON.stringify({ senderid: '<your-id>', name: 'You', msg: 'Hello', roomID: '<room-id>' })
          ...
          <div className="p-10 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl shadow-xl border border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="relative p-8 rounded-2xl bg-white/5 border border-white/10 opacity-60 cursor-not-allowed">
                ...
                <div className="text-4xl font-bold text-white my-6">$9/mo</div>
                <ul className="text-white/70 space-y-3 mb-8">
                ...
                <button
                  className="w-full py-3 rounded-xl bg-gray-400/30 text-white font-semibold"
                  disabled
                >
                  Unavailable
                </button>
        ...
        <div className="p-8 rounded-2xl bg-gradient-to-br from-white/6 to-white/4 backdrop-blur-sm shadow-lg">
          ...
          >
            ...
            <div className="md:col-span-2 flex items-center gap-4">
              ...
              <a href="mailto:sam.megh0305@gmail.com" className="text-white/80">
    ...
    <footer className="w-full">
      <div className="w-full bg-[rgba(255,255,255,0.02)] py-8"> {/* full width background */}
        <div className="max-w-7xl mx-auto px-6">
          <div className="p-6 rounded-2xl bg-gradient-to-br from-white/6 to-white/4 backdrop-blur-sm flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="mailto:sam.megh0305@gmail.com" className="text-white/90 underline">sam.megh0305@gmail.com</a>
              <a href="https://github.com/SamMegh" target="_blank" rel="noreferrer" className="text-white/80">GitHub</a>
              <div className="text-white/60">© {new Date().getFullYear()} Sam Megh</div>
            </div>
          </div>
        </div>
      </div>
